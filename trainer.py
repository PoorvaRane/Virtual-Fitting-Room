...
def loader_epoch(A_loader, B_loader, device, En_A, En_B, De_A, De_B, Disc_A, Disc_B, real, fake, Disc_A_optimizer, Disc_B_optimizer, Gen_optimizer, BCE_loss, L1_loss, train_hist, Disc_A_losses, Disc_B_losses, Gen_losses, angle):
...
def training(args, epoch, device, dataloaders, all_models, BCE_loss, L1_loss, Gen_optimizer, Disc_A_optimizer, Disc_B_optimizer, train_hist):
    ...
    # Front loaders
    Disc_A_losses, Disc_B_losses, Gen_losses, train_hist = loader_epoch(A_front_loader, B_front_loader, device, En_A, En_B, De_A, De_B, Disc_A, Disc_B, real, fake, Disc_A_optimizer, Disc_B_optimizer, Gen_optimizer, BCE_loss, L1_loss, train_hist, Disc_A_losses, Disc_B_losses, Gen_losses, 'front')

    # Back loaders
    Disc_A_losses, Disc_B_losses, Gen_losses, train_hist = loader_epoch(A_back_loader, B_back_loader, device, En_A, En_B, De_A, De_B, Disc_A, Disc_B, real, fake, Disc_A_optimizer, Disc_B_optimizer, Gen_optimizer, BCE_loss, L1_loss, train_hist, Disc_A_losses, Disc_B_losses, Gen_losses, 'back')

    # Side loaders
    Disc_A_losses, Disc_B_losses, Gen_losses, train_hist = loader_epoch(A_side_loader, B_side_loader, device, En_A, En_B, De_A, De_B, Disc_A, Disc_B, real, fake, Disc_A_optimizer, Disc_B_optimizer, Gen_optimizer, BCE_loss, L1_loss, train_hist, Disc_A_losses, Disc_B_losses, Gen_losses, 'side')
